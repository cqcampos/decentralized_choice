...
get_data <- function(rawdata, J, Amat) {
  ...
  # Define cohort indicators for years 
  app_years <- sort(unique(yearapp))   # Years of application cycle: e.g., 2004, ..., 2013
  cohort <- sapply(app_years, function(y) as.integer(yearapp == y))
